odoo.define('pos_technotrade.TransactionManagementControlPanel', function (require) {
    'use strict';
     ...
     * @emits search
     */
    class TransactionManagementControlPanel extends PosComponent {
        setup() {
            super.setup();
            ...
            TransactionFetcher.setSearchDomain(this._computeDomain());
        }
        ...
        get showPageControls() {
            return TransactionFetcher.lastPage > 1;
        }
        get pageNumber() {
            const currentPage = TransactionFetcher.currentPage;
            const lastPage = TransactionFetcher.lastPage;
    ...
    TransactionManagementControlPanel.template = 'TransactionManagementControlPanel';

    Registries.Component.add(TransactionManagementControlPanel);

    return TransactionManagementControlPanel;
});
